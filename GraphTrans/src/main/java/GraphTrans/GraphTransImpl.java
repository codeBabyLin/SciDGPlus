...
public class GraphTransImpl implements GraphTransService {
    ...
    public Iterator<Long[]> allRelationsWithVersions() {
        return this.relationStore.AllRelationsWithVersion();
    }
    ...
    @Override
    public HashMap<String, HashMap<Long, Object>> getRelationProperty(long startNode,long endNode) {
        return this.relationStore.getEntityProperty(startNode,endNode);
    }
}
